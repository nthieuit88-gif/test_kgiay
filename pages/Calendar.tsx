...
const Calendar: React.FC<CalendarProps> = ({ meetings, rooms, onAddMeeting, onUpdateMeeting, isAdmin }) => {
  ...
  const handleBookingSubmit = (e: React.FormEvent) => {
    ...
    const newMeeting: Meeting = {
      ...
      host: 'Nguyễn Văn A (Quản trị viên)',
    ...
    alert('Đã tạo lịch họp thành công!');
  };
      ...
      <header className="shrink-0 z-20 bg-white/95 backdrop-blur-md px-6 py-4 flex items-center justify-between border-b border-slate-200 shadow-sm">
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-extrabold text-slate-800 tracking-tight">Lịch trình hệ thống</h2>
          </div>
        </div>
            ...
            <div className="p-8 border-b border-slate-100 flex items-center justify-between bg-slate-50/50 shrink-0">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 font-medium">Chỉ dành cho Quản trị viên</p>
                </div>
              </div>
